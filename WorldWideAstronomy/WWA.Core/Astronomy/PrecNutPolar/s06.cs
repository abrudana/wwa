...
namespace WorldWideAstronomy
{
   ...
   /* 1 - 3 */
      ...
      new TERM { nfa = new int[] { 0,  0,  0,  0,  1,  0,  0,  0}, s = 1.73e-6, c = -0.03e-6 },
   ...
   /* 1-10 */
      new TERM { nfa = new int[] { 0,  0,  0,  0,  1,  0,  0,  0}, s = 743.52e-6, c = -0.17e-6 },
   ...
   /* 1-4 */
      new TERM { nfa = new int[] { 0,  0,  0,  0,  1,  0,  0,  0}, s = 0.30e-6, c = -23.42e-6 },
      new TERM { nfa = new int[] { 0,  0,  2, -2,  2,  0,  0,  0}, s = -0.03e-6, c = -1.46e-6 },
      new TERM { nfa = new int[] { 0,  0,  2,  0,  2,  0,  0,  0}, s = -0.01e-6, c = -0.25e-6 },
      new TERM { nfa = new int[] { 0,  0,  0,  0,  2,  0,  0,  0}, s = 0.00e-6, c = 0.23e-6 }
   };
