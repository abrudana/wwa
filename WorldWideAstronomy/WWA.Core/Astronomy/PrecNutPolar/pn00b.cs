...
namespace WorldWideAstronomy
{
    public static partial class WWA
    {
        ...
        public static void wwaPn00b(double date1, double date2, ref double dpsi, ref double deps, ref double epsa,
              double[,] rb, double[,] rp, double[,] rbp, double[,] rn, double[,] rbpn)
        {
            /* Nutation. */
            wwaNut00b(date1, date2, ref dpsi, ref deps);

            /* Remaining results. */
            wwaPn00(date1, date2, dpsi, deps, ref epsa, rb, rp, rbp, rn, rbpn);
